...
const BlogInteraction = () => {
    ...
    let { blog, blog: { _id, title, blog_id, activity: { total_likes, total_comments }, activity, author: { personal_info: { username: author_username } } }, setBlog, isLikedByUser, setLikedByUser, commentsWrapper, setCommentsWrapper } = useContext(BlogContext)
        ...
        <>
            ...
            <div className='flex gap-6 justify-between'>
                ...
                <div className='flex gap-3 items-center'>
                    ...
                    <button className='w-9 h-9 rounded-full flex items-center justify-center bg-gray-200/80' onClick={()=>setCommentsWrapper((preVal)=>!preVal)}>
